...
from ..auth import require_token  # Usa el decorador real, ya probado
...
# Función dummy protegida (opcional, para pruebas de rutas protegidas)
def dummy_function():
    return jsonify({'success': True, 'message': 'Función accedida'})
...
def app():
    ...
    # Ruta protegida dummy (opcional, si la necesitas aquí)
    @app.route('/dummy')
    @require_token
    def dummy():
